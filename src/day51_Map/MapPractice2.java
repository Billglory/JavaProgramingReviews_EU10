...
public class MapPractice2 {
    ...
    public static void main(String[] args) {
        ...
        String name2 = "";  // name1 i yazdırdıktan sonra
        int minSalary = Integer.MAX_VALUE; // name1 i yazdırdıktan sonra
        ...
        for (Map.Entry<String, Integer> pair : map.entrySet()) {
            ...
            //     System.out.println(name1); // name1 i yazdırdıktan önce


            if (eachValue < minSalary) {  // name1 i yazdırdıktan sonra
                minSalary = eachValue;
                name2 = eachKey;
