...
public class VariablesIntro {
    ...
    - char define char "A"
            ...
            * data type veriable name = data;

    Variable Naming Rules:

            1. Must be unique (inside the some black_method)
            2. Lover camelCase
        3. We CAN NOT start with numbers
4.We CAN NOT use Java Reserved words
5.For special character_(under score) $ dolar sign
6.make it readable unterstanable
*/

// data type veriable name=date
// we need to use byte()
        int age =34;
//byte mybyte= 129; // we can not this value in a byte from _128 to 127
        short myShort=12;
        long myLong =12232321111l ; // (İf you want to make integer to long  we need to put L or l)
// default data type for compiler is int

        double myDouble= 25.5;
        double myDouble1= 25.5;  // What is my output
